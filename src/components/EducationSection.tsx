      ...
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground mb-3">
            {/* {language === "es" ? "ASDASDASDASDS" : "My CV"} */}
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 justify-items-center">
              {educationData.map((edu, i) => (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="glass-card p-6 hover:box-glow transition-all duration-500 group w-full max-w-md text-center"
                >
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground mb-4">
                    <span className="inline-flex items-center gap-1"><BookOpen className="w-3 h-3" /> {edu.field}</span>
                    <span className="inline-flex items-center gap-1"><TrendingUp className="w-3 h-3" /> {edu.cgpa}</span>
                  </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 justify-items-center">
              {certificates.map((cert, i) => (
                <motion.article
                  ...
                  className="certificate-card w-full max-w-xs text-center"
                >
